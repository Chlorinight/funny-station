...
round-end-summary-window-title = Round OVERRRR!!!! X3
round-end-summary-window-round-end-summary-tab-title = useless info
round-end-summary-window-player-manifest-tab-title = VICTIMS
round-end-summary-window-round-id-label = Round [color=white]#{$roundId}[/color] has ended.
round-end-summary-window-gamemode-name-label = The COOL was [color=white]{$gamemode}[/color].
