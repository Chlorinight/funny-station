...
/// <summary>
///     Assmos - /tg/ gases
///     The ignition of clf3 in the presence of oxygen at temperatures above 373.15K.
...
[UsedImplicitly]
[DataDefinition]
public sealed partial class CLFThreeFireReaction : IGasReactionEffect
{
    public ReactionResult React(GasMixture mixture, IGasMixtureHolder? holder, AtmosphereSystem atmosphereSystem, float heatScale)
    {
        ...
        var burnedFuel = 0f;
        var initialH2 = mixture.GetMoles(Gas.CLFThree);
        ...
        mixture.AdjustMoles(Gas.CLFThree, -burnedFuel);
